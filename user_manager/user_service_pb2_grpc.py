...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VerifyUser = channel.unary_unary(
                '/user_service.UserService/VerifyUser',
...
class DataCollectorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.removeInterest = channel.unary_unary(
                '/user_service.DataCollectorService/removeInterest',
                request_serializer=user__service__pb2.UserRequest.SerializeToString,
                response_deserializer=user__service__pb2.DeletedResponse.FromString,
                _registered_method=True)
...
def add_DataCollectorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'removeInterest': grpc.unary_unary_rpc_method_handler(
                    servicer.removeInterest,
                    request_deserializer=user__service__pb2.UserRequest.FromString,
                    response_serializer=user__service__pb2.DeletedResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'user_service.DataCollectorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('user_service.DataCollectorService', rpc_method_handlers)
...
class DataCollectorService(object):
    ...
    def removeInterest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/user_service.DataCollectorService/removeInterest',
            user__service__pb2.UserRequest.SerializeToString,
            user__service__pb2.DeletedResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
